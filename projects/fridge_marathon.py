...
def post(day=None):
    ...
    match day or datetime.date.today().weekday():
        ...
        case 2:
            blogger = FridgeMarathoner(
                system_prompt, 
                f"Расскажи про профилактику рандомной травмы бегунов с лишним весом. Используй смайлики и не более {word_count} слов. Не используй 'Окей' и 'Конечно'",
        ...
        case 3:
            blogger = FridgeMarathoner(
                system_prompt, 
                f"Выбери актуальную рандомную в беговом сообществе тему. Посмейся над ней. Расскажи, почему она для тебя актуальна. Используй смайлики и не более {word_count} слов. Не используй 'Окей' и 'Конечно'",
        ...
        case 5:
            blogger = FridgeMarathoner(
                system_prompt, 
                f"Сегодня чит-мил день. Выбери рандомное блюдо с высоким содержанием сахара или углеводов. Расскажи его историю и о том, как ты, смакуя, съел его после тренировки. Используй смайлики и не более {word_count} слов. Не используй 'Окей' и 'Конечно'",
