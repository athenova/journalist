...
class HorrorWriter(Journalist):
    def _message_generator(self):
        ...
        return DeepSeekTextGenerator("Ты - писатель. Специализируешься на хоррорах. Я буду давать тебе тему, жанр и автора. Придумай небольшой хоррор-рассказ на заданную тему, в заданном жанре, в стиле заданного автора. Используй структуру: заглавие, рассказ.")
...
def post(offset=0):
    ...
    tasks = json.load(open(f"./files/author/3_33/3_33_themes.json", "rt", encoding="UTF-8"))
    authors = json.load(open(f"./files/author/3_33/3_33_authors.json", "rt", encoding="UTF-8"))
