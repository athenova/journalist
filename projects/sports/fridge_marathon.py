...
def post(day=None):
    ...
    match day or datetime.date.today().weekday():
        case 0:
            tasks = json.load(open("./files/sportsfridge_marathon1.json", "rt", encoding="UTF-8"))
        ...
        case 2:
            tasks = json.load(open("./files/sportsfridge_marathon3.json", "rt", encoding="UTF-8"))
            index = index % len(tasks)
            task = tasks[index]
            blogger = FridgeMarathoner(
                system_prompt, 
        ...
        case 3:
            tasks = json.load(open("./files/sportsfridge_marathon4.json", "rt", encoding="UTF-8"))
            index = index % len(tasks)
            task = tasks[index]
            blogger = FridgeMarathoner(
                system_prompt, 
        ...
        case 5:
            tasks = json.load(open("./files/sportsfridge_marathon6.json", "rt", encoding="UTF-8"))
            index = index % len(tasks)
            task = tasks[index]
            blogger = FridgeMarathoner(
                system_prompt, 
