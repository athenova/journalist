...
class SkillBlogger(AutoSimpleBlogger):
    def _tasks_file_path(self):
        return f"./files/edu/one_day_skill.json"
    
    def _message_prompt_constructor(self, task):
        return f"Расскажи как {task['name']}. Используй структуру: заглавие, основная часть. Используй смайлики и не более 100 слов."
